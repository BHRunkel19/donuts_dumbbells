...
let sprinkles_fall = document.createElement("button");
sprinkles_fall.setAttribute("id", "sprinkles_fall");
...
main_content.appendChild(sprinkles_fall);
...
sprinkles_fall.addEventListener("click", function(){
